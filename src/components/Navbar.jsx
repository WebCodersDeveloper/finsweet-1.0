...
export default function Navbar() {
  return (
    <div className="bg-white w-full h-16 flex items-center justify-around gap-20">
        ...
        <ul className='flex gap-10 h-full items-center'>
            ...
            <li className='bg-[#1D2130] flex items-center justify-center rounded-md  w-[115px] h-[43px]'>
                <Link to='/donate' className='font-roboto rounded-md text-base text-white focus-within:text-black focus-within:font-medium'>Donate</Link>
            </li>
        </ul>
    </div>
  )
